...
module.exports = class ResponseInterface 
{
  ...
  /**
   * 
   * @param {any} data - data that will be sent to client as a response 
   */
  complete(data) {
   ...
   * @deprecated This method is deprecated. Consider using setHeader(key, value) instead.
   * */
  header (key, value)
  {
    console.warn("This method is deprecated. Consider using setHeader(key, value) instead.");
    this.headers[key] = value;
  }
