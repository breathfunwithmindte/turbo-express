...
module.exports = class TurboServer
{
   ...
   * @description Override default behaviour of the Request object of the server. 
   * @returns 
   */
  overrideResponse(response) {
    const instance = new response()
    
    if((instance instanceof ResponseInterface) == false) {
      return console.log("Your class has to extend Response Interface to override default response behaviour") 
    } 
