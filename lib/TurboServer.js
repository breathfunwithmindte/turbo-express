...
module.exports = class TurboServer
{
  ...
  overrideResponse(ResponseClass) {
    const instance = new ResponseClass()
    if(instance instanceof ResponseInterface == false) return console.log("You can't override response with class that doesn't implements RequestInterface")
